...
$query = "SELECT * FROM admin_packages WHERE availability = 'Available' ORDER BY id DESC";
...
<head>
    ...
    <style>
        ...
        .package-actions a:hover {
            background-color: rgb(61, 255, 142);
            transform: scale(1.05);
            /* Slight scaling effect */
        }

        .package-actions a.delete {
            background-color: #e63946;
        }

        .package-actions a.delete:hover {
            background-color: rgba(214, 40, 40, 0.51);
        }
